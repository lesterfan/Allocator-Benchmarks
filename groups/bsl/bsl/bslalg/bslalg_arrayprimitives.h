                ...
                ARGS&&...                                           arguments)
{
    ...
    *fromEndPtr = fromEnd;
    ...
    // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
                             // Changed : allocator,
                             // Changed : toPositionBegin,
    ::new(toPositionBegin) TargetType(
                             BSLS_COMPILERFEATURES_FORWARD(ARGS,arguments)...);
    // Changed: ::new(voidify(toPositionBegin)) TargetType( BSLS_COMPILERFEATURES_FORWARD(ARGS,arguments)... );
                ...
                BSLS_COMPILERFEATURES_FORWARD_REF(ARGS_01) arguments_01)
{
    ...
    *fromEndPtr = fromEnd;
    ...
    // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
                             // Changed : allocator,
                             // Changed : toPositionBegin,
                          // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS_01,arguments_01));
    ::new(toPositionBegin) TargetType( BSLS_COMPILERFEATURES_FORWARD(ARGS_01,arguments_01) );
                                     ...
                                     bslmf::MetaInt<e_NIL_TRAITS> *)
{
    ...
    do {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct( // Changed : *allocator,
        ::new(begin) TARGET_TYPE(
                                                     value);
                                       ...
                                       bslmf::MetaInt<e_NIL_TRAITS> *)
{
    ...
    while (fromBegin != fromEnd) {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator,
            // Changed : toBegin,
            // Changed : bslmf::MovableRefUtil::move(*fromBegin));


    
        ::new(toBegin)
            TARGET_TYPE(bslmf::MovableRefUtil::move(*fromBegin));
                                       ...
                                       bslmf::MetaInt<e_NIL_TRAITS> *)
{
    ...
    while (fromBegin != fromEnd) {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator,
            // Changed : toBegin,
            // Changed : bslmf::MovableRefUtil::move_if_noexcept(*fromBegin));

        ::new(toBegin)
            TARGET_TYPE(bslmf::MovableRefUtil::move_if_noexcept(*fromBegin));
                          ...
                          ARGS&&...                                  args)
{
    ...
    while (guard.middle() != guard.end()) {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(// Changed : allocator,
                                                    // Changed : guard.destination(),
                                 // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS, args)...);

        ::new(guard.destination())
                                 TARGET_TYPE(BSLS_COMPILERFEATURES_FORWARD(ARGS, args)...);
        guard.advance();
    }
                                  ...
                                  ARGS&&...                     args)
{
    ...
    if (toEnd > toBegin) {
        ...
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator,
            // Changed : BSLS_UTIL_ADDRESSOF(space.object()),
            // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS, args)...);

        ::new(BSLS_UTIL_ADDRESSOF(space.object()))
            TARGET_TYPE(BSLS_COMPILERFEATURES_FORWARD(ARGS, args)...);
        ...
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator,
            // Changed : toEnd,
            // Changed : bslmf::MovableRefUtil::move_if_noexcept(*(toEnd - 1)));

            // Changed : allocator,
        ::new(toEnd)
            TARGET_TYPE(bslmf::MovableRefUtil::move_if_noexcept(*(toEnd - 1)));
        ...
        *toBegin = bslmf::MovableRefUtil::move_if_noexcept(space.object());
        ...
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed :  allocator, 
            // Changed : toEnd, BSLS_COMPILERFEATURES_FORWARD(ARGS, args)...);

        ::new(toEnd) TARGET_TYPE(BSLS_COMPILERFEATURES_FORWARD(ARGS, args)...);
    }
}
#elif BSLS_COMPILERFEATURES_SIMULATE_VARIADIC_TEMPLATES
// {{{ BEGIN GENERATED CODE
                          ...
                          bslmf::MetaInt<e_BITWISE_MOVEABLE_TRAITS> *)
{
    ...
    while (guard.middle() != guard.end()) {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct( // Changed : allocator,
                                                    // Changed : guard.destination());
        ::new(guard.destination()) TARGET_TYPE();
        guard.advance();
    }
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(ARGS_01) args_01)
{
    ...
    while (guard.middle() != guard.end()) {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(// Changed : allocator,
                                                    // Changed : guard.destination(),
                              // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS_01, args_01));

        ::new(guard.destination())
                  TARGET_TYPE(BSLS_COMPILERFEATURES_FORWARD(ARGS_01, args_01));
        guard.advance();
    }
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(ARGS_02) args_02)
{
    ...
    while (guard.middle() != guard.end()) {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct( // Changed : allocator,
                                                    // Changed : guard.destination(),
                              // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS_01, args_01),
                              // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS_02, args_02));
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(ARGS_03) args_03)
{
    ...
    while (guard.middle() != guard.end()) {
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct( // Changed : allocator,
                              ...
                              // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS_01, args_01),
                              // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS_02, args_02),
                              // Changed : BSLS_COMPILERFEATURES_FORWARD(ARGS_03, args_03));
                                  ...
                                  bslmf::MetaInt<e_NIL_TRAITS> *)
{
    ...
    if (toEnd > toBegin) {
        ...
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator,
        ::new(BSLS_UTIL_ADDRESSOF(space.object())) TARGET_TYPE();
        bslma::DestructorProctor<TARGET_TYPE> temp(
                                          BSLS_UTIL_ADDRESSOF(space.object()));
                            ...
                            BSLS_COMPILERFEATURES_FORWARD_REF(ARGS_01) args_01)
{
    ...
    if (toEnd > toBegin) {
        ...
        *toBegin = bslmf::MovableRefUtil::move_if_noexcept(space.object());
        ...
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator,
        ::new(toEnd) TARGET_TYPE(BSLS_COMPILERFEATURES_FORWARD(ARGS_01, args_01));
    }
}
#endif  // BSLALG_ARRAYPRIMITIVES_VARIADIC_LIMIT_F >= 1
                            ...
                            BSLS_COMPILERFEATURES_FORWARD_REF(ARGS_07) args_07)
{
    ...
    if (toEnd > toBegin) {
        ...
        *toBegin = bslmf::MovableRefUtil::move_if_noexcept(space.object());
        ...
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator, 
        ::new(toEnd) BSLS_COMPILERFEATURES_FORWARD(ARGS_01, args_01),
                              BSLS_COMPILERFEATURES_FORWARD(ARGS_02, args_02),
                              BSLS_COMPILERFEATURES_FORWARD(ARGS_03, args_03),
                              BSLS_COMPILERFEATURES_FORWARD(ARGS_04, args_04),
                              BSLS_COMPILERFEATURES_FORWARD(ARGS_05, args_05),
                                 ...
                                 bslmf::MetaInt<e_NIL_TRAITS>   *)
{
    ...
    if (toBegin < toEnd) {
        ...
        *toBegin = bslmf::MovableRefUtil::move(lvalue);
        ...
        // Changed : bsl::allocator_traits<ALLOCATOR>::construct(
            // Changed : allocator,
        ::new(toBegin) TARGET_TYPE( bslmf::MovableRefUtil::move(lvalue));
    }
}
                                 ...
                                 bslmf::MetaInt<e_NIL_TRAITS> *)
{
    ...
    if (tailLen >= numElements) {
        ...
        bsls::ObjectBuffer<TARGET_TYPE> space;
        // Changed : bslma::ConstructionUtil::construct(BSLS_UTIL_ADDRESSOF(space.object()),
        ::new(BSLS_UTIL_ADDRESSOF(space.object()))
                                           // Changed : bslma::Default::allocator(),
                TARGET_TYPE(value);
        bslma::DestructorProctor<TARGET_TYPE> temp(
                                          BSLS_UTIL_ADDRESSOF(space.object()));
