...
// Lester: This doesn't care about allocators, I can ignore this.
...
class String_Imp {
  ...
  public:
    ...
    enum ShortBufferConstraints {
        ...
        #ifndef MAKE_STRINGS_LONGER
        SHORT_BUFFER_MIN_BYTES  = 20, // minimum required size of the short
                                      // string buffer in bytes
        #else
        SHORT_BUFFER_MIN_BYTES  = 20 + sizeof(char*), // minimum required size of the short
                                                      // string buffer in bytes
        #endif
...
class basic_string
    : private String_Imp<CHAR_TYPE, size_t>
{
  ...
  private:
    // PRIVATE TYPES
    typedef String_Imp<CHAR_TYPE, size_t> Imp;
    ...
    // INVARIANTS
    // Lester : Maybe change later? - BSLMF_ASSERT((bsl::is_same<CHAR_TYPE,
    // Lester : Maybe change later? -                            typename ALLOCATOR::value_type>::value));
  ...
  public:
    ...
    basic_string(const CHAR_TYPE  *characterString);   // IMPLICIT
    ...
    basic_string(const native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>& original);
        // IMPLICIT
        // Create a string that has the same value as the specified 'original'
    ...
    bslma::Allocator* get_allocator() const BSLS_CPP11_NOEXCEPT;
    ...
    operator native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>() const;
...
// FREE OPERATORS
template <class CHAR_TYPE, class CHAR_TRAITS>
bool operator==(const basic_string<CHAR_TYPE,CHAR_TRAITS>&  lhs,
                const basic_string<CHAR_TYPE,CHAR_TRAITS>&  rhs)
                                                           BSLS_CPP11_NOEXCEPT;
template <class CHAR_TYPE, class CHAR_TRAITS>
bool
operator==(const native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>& lhs,
           const bsl::basic_string<CHAR_TYPE,CHAR_TRAITS>&        rhs)
                                                           BSLS_CPP11_NOEXCEPT;
template <class CHAR_TYPE, class CHAR_TRAITS>
bool
operator==(const bsl::basic_string<CHAR_TYPE,CHAR_TRAITS>&        lhs,
           const native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>& rhs)
                                                           BSLS_CPP11_NOEXCEPT;
template <class CHAR_TYPE, class CHAR_TRAITS>
...
operator+(const basic_string<CHAR_TYPE,CHAR_TRAITS>&  lhs,
          const basic_string<CHAR_TYPE,CHAR_TRAITS>&  rhs);
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>
operator+(const native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>& lhs,
...
operator<<(std::basic_ostream<CHAR_TYPE, CHAR_TRAITS>&          os,
           const basic_string<CHAR_TYPE,CHAR_TRAITS>& str);
...
operator>>(std::basic_istream<CHAR_TYPE, CHAR_TRAITS>&     is,
           basic_string<CHAR_TYPE,CHAR_TRAITS>& str);
...
// FREE FUNCTIONS
template <class CHAR_TYPE, class CHAR_TRAITS>
void swap(basic_string<CHAR_TYPE,CHAR_TRAITS>& a,
          basic_string<CHAR_TYPE,CHAR_TRAITS>& b)
             BSLS_CPP11_NOEXCEPT_SPECIFICATION(BSLS_CPP11_PROVISIONALLY_FALSE);
...
void hashAppend(
    HASHALG&                                                           hashAlg,
    const native_std::basic_string<CHAR_TYPE, CHAR_TRAITS>& input);
    // Pass the specified 'input' string to the specified 'hashAlg' hashing
...
// CLASS DATA
template <class CHAR_TYPE, class CHAR_TRAITS>
const typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::npos;
...
inline
void
basic_string<CHAR_TYPE, CHAR_TRAITS>::privateThrowLengthError(
...
inline
void
basic_string<CHAR_TYPE, CHAR_TRAITS>::privateThrowOutOfRange(
                                                        bool        outOfRange,
                                                        const char *message)
{
...
inline
CHAR_TYPE *
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateAllocate(size_type numChars)
{
    // Changed : return this->allocateN((CHAR_TYPE *)0, numChars + 1);

    // printf("Lester : Running privateAllocate!\n");

    // printf("Lester : Getting allocator!\n");
    bslma::Allocator* currAllocator = get_allocator();

    CHAR_TYPE* result = static_cast<CHAR_TYPE*>(currAllocator->allocate( (numChars + 1)*sizeof(CHAR_TYPE) ));
    
    // printf("After the allocate!");
    // CHAR_TYPE* result = static_cast<CHAR_TYPE*>(get_allocator()->allocate(numChars + 1));
    return result;
}

template <class CHAR_TYPE, class CHAR_TRAITS>
inline
void basic_string<CHAR_TYPE,CHAR_TRAITS>::privateDeallocate()
{
    if (!this->isShortString()) {
        // Changed : this->deallocateN(this->d_start_p, this->d_capacity + 1);
        // printf("Lester : Deallocating %p\n", this->d_start_p);

        get_allocator()->deallocate(this->d_start_p);
    }
}
...
inline
void
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateCopyFromOutOfPlaceBuffer(
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateAppend(
                                              const CHAR_TYPE *characterString,
                                              size_type        numChars,
                                              const char      *message)
{
                                                       ...
                                                       std::input_iterator_tag)
{
    ...
    // printf("Lester : Running privateAppend\n");
    // Changed : basic_string temp(get_allocator());
    bslma::Allocator* currAlloc0 = get_allocator();
    basic_string& temp = *new(*currAlloc0) basic_string();
    bslma::RawDeleterProctor<basic_string, bslma::Allocator> dp0(&temp, currAlloc0);
...
inline
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateAppendDispatch(
                              INPUT_ITER                              first,
                              INPUT_ITER                              last,
                              const char                             *message,
                              BloombergLP::bslmf::MatchArithmeticType,
...
inline
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateAssignDispatch(
                                                          FIRST_TYPE   first,
                                                          SECOND_TYPE  second,
                                                          const char  *message)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE, CHAR_TRAITS>::Imp&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateBase()
{
    return *static_cast<Imp *>(this);
}

template <class CHAR_TYPE, class CHAR_TRAITS>
void basic_string<CHAR_TYPE,CHAR_TRAITS>::privateClear(
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
void basic_string<CHAR_TYPE,CHAR_TRAITS>::privateInsertDispatch(
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateInsertRaw(
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateReplaceRaw(
                                              size_type        outPosition,
                                              size_type        outNumChars,
                                              const CHAR_TYPE *characterString,
                                              size_type        numChars)
{
    ...
    const size_type displacement =
                          static_cast<size_type>(numChars - outNumChars);
...
inline
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateReplaceDispatch(
                              size_type                               position,
                              size_type                               numChars,
                              INPUT_ITER                              first,
                              INPUT_ITER                              last,
...
template <class INPUT_ITER>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateReplace(
                                                       size_type  outPosition,
                                                       size_type  outNumChars,
                                                       INPUT_ITER first,
                                                       INPUT_ITER last,
                                                       std::input_iterator_tag)
{
    ...
    // printf("Lester : Running privateReplace\n");
    // Changed : basic_string temp(get_allocator());
    bslma::Allocator* currAlloc1 = get_allocator();
    basic_string& temp = *new(*currAlloc1) basic_string();
    bslma::RawDeleterProctor<basic_string, bslma::Allocator> dp1(&temp, currAlloc1);
    for (; first != last; ++first) {
        temp.push_back(*first);
    }
...
template <class CHAR_TYPE, class CHAR_TRAITS>
void basic_string<CHAR_TYPE,CHAR_TRAITS>::privateReserveRaw(
                                                         size_type newCapacity)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
CHAR_TYPE *
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateReserveRaw(
                                                        size_type *storage,
                                                        size_type  newCapacity,
                                                        size_type  numChars)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::privateResizeRaw(
                                                           size_type newLength,
                                                           CHAR_TYPE character)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
void basic_string<CHAR_TYPE,CHAR_TRAITS>::
...
// PRIVATE ACCESSORS
template <class CHAR_TYPE, class CHAR_TRAITS>
int basic_string<CHAR_TYPE,CHAR_TRAITS>::privateCompareRaw(
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
basic_string<CHAR_TYPE,CHAR_TRAITS>::basic_string()
                                                            BSLS_CPP11_NOEXCEPT
: Imp()
{
    CHAR_TRAITS::assign(*begin(), CHAR_TYPE());
...
// ----------------------- Not really sure how to deal with this ---------------- Lester
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
basic_string<CHAR_TYPE,CHAR_TRAITS>::basic_string(
...
// ----------------------- End : Not really sure how to deal with this ---------------- Lester
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>::basic_string(
  const native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>& original)
: Imp()
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::operator=(
              ...
              BSLS_CPP11_NOEXCEPT_SPECIFICATION(BSLS_CPP11_PROVISIONALLY_FALSE)
{
    ...
    // printf("Lester : Running operator = \n");
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::operator=(const CHAR_TYPE *rhs)
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::operator=(CHAR_TYPE character)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
BSLS_PLATFORM_AGGRESSIVE_INLINE
void basic_string<CHAR_TYPE,CHAR_TRAITS>::resize(size_type newLength,
                                                           CHAR_TYPE character)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
BSLS_PLATFORM_AGGRESSIVE_INLINE
void basic_string<CHAR_TYPE,CHAR_TRAITS>::reserve(
                                                         size_type newCapacity)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
BSLS_PLATFORM_AGGRESSIVE_INLINE
void basic_string<CHAR_TYPE,CHAR_TRAITS>::clear() BSLS_CPP11_NOEXCEPT
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::begin() BSLS_CPP11_NOEXCEPT
{
    return this->dataPtr();
}
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::end() BSLS_CPP11_NOEXCEPT
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::reverse_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::rbegin() BSLS_CPP11_NOEXCEPT
{
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::reverse_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::rend() BSLS_CPP11_NOEXCEPT
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::reference
basic_string<CHAR_TYPE,CHAR_TRAITS>::operator[](size_type position)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::reference
basic_string<CHAR_TYPE,CHAR_TRAITS>::at(size_type position)
{
...
inline
CHAR_TYPE&
basic_string<CHAR_TYPE,CHAR_TRAITS>::front()
{
...
inline
CHAR_TYPE&
basic_string<CHAR_TYPE,CHAR_TRAITS>::back()
{
    BSLS_ASSERT_SAFE(!empty());
...
basic_string<CHAR_TYPE,CHAR_TRAITS>::
    operator native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>() const
{
    native_std::basic_string<CHAR_TYPE,CHAR_TRAITS> result;
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::append(
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::append(size_type numChars,
                                                      CHAR_TYPE character)
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::append(INPUT_ITER first,
                                                      INPUT_ITER last)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
void basic_string<CHAR_TYPE,CHAR_TRAITS>::push_back(
                                                           CHAR_TYPE character)
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::assign(
                                               const basic_string& replacement)
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::assign(size_type numChars,
                                                      CHAR_TYPE character)
{
    return privateAssignDispatch(
                                  numChars,
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::assign(INPUT_ITER first,
                                                      INPUT_ITER last)
{
    return privateAssignDispatch(
                            first,
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::insert(
                                                  size_type           position,
                                                  const basic_string& other)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::insert(size_type position,
                                                      size_type numChars,
                                                      CHAR_TYPE character)
{
    privateThrowOutOfRange(position > length(),
...
template <class CHAR_TYPE, class CHAR_TRAITS>
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::insert(const_iterator position,
                                                      CHAR_TYPE      character)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::erase(size_type position,
                                                     size_type numChars)
{
    privateThrowOutOfRange(position > length(),
...
template <class CHAR_TYPE, class CHAR_TRAITS>
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::erase(const_iterator position)
{
    BSLS_ASSERT_SAFE(position >= cbegin());
    BSLS_ASSERT_SAFE(position < cend());
...
template <class CHAR_TYPE, class CHAR_TRAITS>
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::erase(const_iterator first,
                                                     const_iterator last)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
void basic_string<CHAR_TYPE,CHAR_TRAITS>::pop_back()
{
    BSLS_ASSERT_SAFE(!empty());
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::replace(
                                               size_type           outPosition,
                                               size_type           outNumChars,
                                               const basic_string& replacement)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>&
basic_string<CHAR_TYPE,CHAR_TRAITS>::replace(size_type outPosition,
                                                       size_type outNumChars,
                                                       size_type numChars,
                                                       CHAR_TYPE character)
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
void
basic_string<CHAR_TYPE,CHAR_TRAITS>::swap(basic_string& other)
              BSLS_CPP11_NOEXCEPT_SPECIFICATION(BSLS_CPP11_PROVISIONALLY_FALSE)
{
    // printf("Running swap\n");
    if (BSLS_PERFORMANCEHINT_PREDICT_LIKELY(
        ...
        // Change this as well
        // Changed : basic_string toThisCopy(MoveUtil::move(other), get_allocator());
        bslma::Allocator* currAlloc2 = get_allocator();
        basic_string& toThisCopy = *new(*currAlloc2) basic_string(MoveUtil::move(other));
        bslma::RawDeleterProctor<basic_string, bslma::Allocator> dp2(&toThisCopy, currAlloc2);

        // Changed : basic_string toOtherCopy(MoveUtil::move(*this), other.get_allocator());
        bslma::Allocator* currAlloc3 = other.get_allocator();
        basic_string& toOtherCopy = *new(*currAlloc3) basic_string(MoveUtil::move(*this));
        bslma::RawDeleterProctor<basic_string, bslma::Allocator> dp3(&toOtherCopy, currAlloc3);
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::begin() const
                                                            BSLS_CPP11_NOEXCEPT
{
    return this->dataPtr();
}
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::cbegin() const
                                                            BSLS_CPP11_NOEXCEPT
{
    return begin();
}
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::end() const BSLS_CPP11_NOEXCEPT
{
    return begin() + this->d_length;
}
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::cend() const BSLS_CPP11_NOEXCEPT
{
    return end();
}
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_reverse_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::rbegin() const
                                                            BSLS_CPP11_NOEXCEPT
{
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_reverse_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::crbegin() const
                                                            BSLS_CPP11_NOEXCEPT
{
    return const_reverse_iterator(end());
}
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_reverse_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::rend() const
                                                            BSLS_CPP11_NOEXCEPT
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_reverse_iterator
basic_string<CHAR_TYPE,CHAR_TRAITS>::crend() const
                                                            BSLS_CPP11_NOEXCEPT
{
    return const_reverse_iterator(begin());
}
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::size() const
                                                            BSLS_CPP11_NOEXCEPT
{
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::length() const
                                                            BSLS_CPP11_NOEXCEPT
{
    return this->d_length;
}
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::max_size() const
                                                            BSLS_CPP11_NOEXCEPT
{
    ...
    // Changed : size_type allocMaxSize  = get_allocator()->max_size() - 1;
    // ^ There is no max size parameter on bslma::Allocator
    size_type allocMaxSize = INT_MAX;
...
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::capacity() const
                                                            BSLS_CPP11_NOEXCEPT
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
bool basic_string<CHAR_TYPE,CHAR_TRAITS>::empty() const
                                                            BSLS_CPP11_NOEXCEPT
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_reference
basic_string<CHAR_TYPE,CHAR_TRAITS>::operator[](
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::const_reference
basic_string<CHAR_TYPE,CHAR_TRAITS>::at(size_type position) const
{
...
inline
const CHAR_TYPE&
basic_string<CHAR_TYPE,CHAR_TRAITS>::front() const
{
    BSLS_ASSERT_SAFE(!empty());
...
inline
const CHAR_TYPE&
basic_string<CHAR_TYPE,CHAR_TRAITS>::back() const
{
    BSLS_ASSERT_SAFE(!empty());
...
template <class CHAR_TYPE, class CHAR_TRAITS>
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::copy(CHAR_TYPE *characterString,
                                                    size_type  numChars,
                                                    size_type  position) const
{
    BSLS_ASSERT_SAFE(characterString);
...
inline
const CHAR_TYPE *
basic_string<CHAR_TYPE,CHAR_TRAITS>::c_str() const
                                                            BSLS_CPP11_NOEXCEPT
{
    return this->dataPtr();
}
...
inline
const CHAR_TYPE*
basic_string<CHAR_TYPE,CHAR_TRAITS>::data() const
                                                            BSLS_CPP11_NOEXCEPT
{
    return this->dataPtr();
}
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
typename bslma::Allocator*
basic_string<CHAR_TYPE,CHAR_TRAITS>::get_allocator() const
                                                            BSLS_CPP11_NOEXCEPT
{
    void* this_allocator = bslma::AllocatorDatabase::lookup(this);
    // printf("Running lookup! This = %p, this_allocator = %p\n", this, this_allocator);
    return static_cast<bslma::Allocator*>(this_allocator);
}

template <class CHAR_TYPE, class CHAR_TRAITS>
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::find(
...
template <class CHAR_TYPE, class CHAR_TRAITS>
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::find(CHAR_TYPE character,
                                                    size_type position) const
{
    if (position >= length()) {
        return npos;                                                  // RETURN
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::rfind(
                                            const basic_string& substring,
                                            size_type           position) const
                                                            BSLS_CPP11_NOEXCEPT
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::rfind(CHAR_TYPE character,
                                                     size_type position) const
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::find_first_of(
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::find_last_of(
                                           const basic_string& characterString,
                                           size_type           position) const
                                                            BSLS_CPP11_NOEXCEPT
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::find_first_not_of(
                                           const basic_string& characterString,
                                           size_type           position) const
                                                            BSLS_CPP11_NOEXCEPT
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
typename basic_string<CHAR_TYPE,CHAR_TRAITS>::size_type
basic_string<CHAR_TYPE,CHAR_TRAITS>::find_last_not_of (
                                           const basic_string& characterString,
                                           size_type           position) const
                                                            BSLS_CPP11_NOEXCEPT
{
...
BSLS_PLATFORM_AGGRESSIVE_INLINE
basic_string<CHAR_TYPE,CHAR_TRAITS>
basic_string<CHAR_TYPE,CHAR_TRAITS>::substr(size_type position,
                                                      size_type numChars) const
{
    return basic_string<CHAR_TYPE,
                        CHAR_TRAITS>(*this, position, numChars);
}

template <class CHAR_TYPE, class CHAR_TRAITS>
BSLS_PLATFORM_AGGRESSIVE_INLINE
int basic_string<CHAR_TYPE,CHAR_TRAITS>::compare(
                                               const basic_string& other) const
                                                            BSLS_CPP11_NOEXCEPT
{
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
void bsl::swap(basic_string<CHAR_TYPE,CHAR_TRAITS>& a,
               basic_string<CHAR_TYPE,CHAR_TRAITS>& b)
              BSLS_CPP11_NOEXCEPT_SPECIFICATION(BSLS_CPP11_PROVISIONALLY_FALSE)
{
    a.swap(b);
...
template <class CHAR_TYPE, class CHAR_TRAITS>
inline
bool bsl::operator==(const basic_string<CHAR_TYPE,CHAR_TRAITS>& lhs,
                     const basic_string<CHAR_TYPE,CHAR_TRAITS>& rhs)
                                                            BSLS_CPP11_NOEXCEPT
{
...
bool
bsl::operator==(
             const native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>& lhs,
             const bsl::basic_string<CHAR_TYPE,CHAR_TRAITS>&        rhs)
                                                            BSLS_CPP11_NOEXCEPT
{
    return lhs.size() == rhs.size()
...
bool
bsl::operator==(
             const bsl::basic_string<CHAR_TYPE,CHAR_TRAITS>&        lhs,
             const native_std::basic_string<CHAR_TYPE,CHAR_TRAITS>& rhs)
                                                            BSLS_CPP11_NOEXCEPT
{
    return lhs.size() == rhs.size()
...
template <class CHAR_TYPE, class CHAR_TRAITS>
bsl::basic_string<CHAR_TYPE,CHAR_TRAITS>
bsl::operator+(const basic_string<CHAR_TYPE,CHAR_TRAITS>& lhs,
               const basic_string<CHAR_TYPE,CHAR_TRAITS>& rhs)
{
    basic_string<CHAR_TYPE,CHAR_TRAITS> result;
...
bsl::operator+(
             ...
             const bsl::basic_string<CHAR_TYPE,CHAR_TRAITS>&        rhs)
{
    bsl::basic_string<CHAR_TYPE,CHAR_TRAITS> result;
    result.reserve(lhs.length() + rhs.length());
...
template <class CHAR_TYPE, class CHAR_TRAITS>
struct HasStlIterators<bsl::basic_string<CHAR_TYPE, CHAR_TRAITS> >
    : bsl::true_type
{};
...
// Changed : template <class CHAR_TYPE, class CHAR_TRAITS>
// Changed : struct UsesBslmaAllocator<bsl::basic_string<CHAR_TYPE, CHAR_TRAITS> >
    // Changed : : bsl::is_convertible<Allocator *>
// Changed : {};
