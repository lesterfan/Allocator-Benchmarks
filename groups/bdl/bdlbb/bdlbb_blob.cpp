...
int Blob::assertInvariants() const
{
    ...
    for (dataIter = d_buffers.begin(); dataIter != d_buffers.end();
         ++dataIter) {
...
// CREATORS
Blob::Blob()
: d_buffers(static_cast<bslma::Allocator*>(bslma::AllocatorDatabase::lookup(this)))
, d_totalSize(0)
, d_dataLength(0)
, d_dataIndex(0)
, d_preDataIndexLength(0)
...
: d_buffers(buffers, buffers + numBuffers, static_cast<bslma::Allocator*>(bslma::AllocatorDatabase::lookup(this)))
, d_totalSize(0)
, d_dataLength(0)
, d_dataIndex(0)
, d_preDataIndexLength(0)
...
Blob::Blob(const Blob&        original,
           BlobBufferFactory *factory)
: d_buffers(original.d_buffers, static_cast<bslma::Allocator*>(bslma::AllocatorDatabase::lookup(this)))
